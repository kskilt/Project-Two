...
Rails.application.configure do
  ...
  # `config.assets.version` have moved to config/
  ...
  # Strict-Transport-Security, and use secure
  # cookies.
  ...
  # Use a real queuing backend for Active Job (and
  # separate queues per environment)
  # config.active_job.queue_adapter     = :resque
  # config.active_job.queue_name_prefix =
  # "project_two_#{Rails.env}"
